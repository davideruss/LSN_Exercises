...
public:
  ...
  // Method to generate a random number with a p(x) = 2*(1-x) distribution
  double distribuzione1();

  int choice(int valore_1, int valore_2);
  
  int randint(int valore_min, int valore_max);
};
